...
export function Profil() {
  ...
  const handleAddAd = () => {
    if (!newAdTitle || !newAdPrice || !newAdImageFile || !newAdCategory) {
      // Added newAdCategory validation
      alert(
        "Veuillez remplir tous les champs et ajouter une image pour l'annonce."
      );
      return;
    }
  ...
  const handleDeleteCategory = (categoryToDelete) => {
    ...
    if (isCategoryUsed) {
      alert(
        `Impossible de supprimer la catégorie "${categoryToDelete}" car elle est utilisée par une ou plusieurs annonces.`
      );
      return;
    }

    const updatedCategories = globalCategories.filter(
  ...
  return (
    <div className="container-fluid py-4 min-vh-100 bg-light">
        ...
        <div className="col-md-3">
          <div className="card shadow-sm h-100 d-flex flex-column">
            ...
            <div className="list-group list-group-flush border-top">
              ...
              <button
                className={`list-group-item list-group-item-action py-3 ${
                  activeSection === "ads" ? "active bg-primary text-white" : ""
                }`}
        ...
        <div className="col-md-9">
          <div className="card shadow-sm p-4 h-100">
              ...
              <div>
                ...
                {isEditing ? (
                  <div>
                    ...
                    <div className="mb-3">
                      <label htmlFor="editedLocation" className="form-label">
                        Localisation
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      <label htmlFor="editedBio" className="form-label">
                        Biographie
                      </label>
                      <textarea
                        className="form-control"
                  ...
                  <div>
                    ...
                    <p className="mb-2">
                      <strong>Membre depuis :</strong> {currentUser.memberSince}
                    </p>
                    <p className="mb-2">
                      <strong>Localisation :</strong> {currentUser.location}
                    </p>
                    <p className="mb-4">
                    ...
                    >
                      <i className="bi bi-pencil-square me-2"></i> Modifier mon
                      Profil
                    </button>
                  </div>
                )}
            ...
            {activeSection === "ads" && (
              <div>
                <h3 className="mb-4 text-primary">
                  <i className="bi bi-megaphone me-2"></i> Mes Annonces
                </h3>
                <p className="text-muted border-bottom pb-2 mb-3">
                  Gérez vos annonces publiées et ajoutez de nouvelles offres.
                </p>

                {/* Add New Ad Form */}
                <div className="card mb-4 p-3 border-primary-subtle bg-light">
                  <h4 className="mb-3 text-primary-emphasis">
                    <i className="bi bi-plus-circle me-2"></i> Publier une
                    nouvelle annonce
                  </h4>
                  <div className="mb-3">
                    <label htmlFor="newAdTitle" className="form-label">
                      Titre de l'annonce
                    </label>
                    <input
                      type="text"
                      className="form-control"
                      id="newAdTitle"
                      placeholder="Ex: Vélo de course presque neuf"
                      value={newAdTitle}
                      onChange={(e) => setNewAdTitle(e.target.value)}
                    />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="newAdPrice" className="form-label">
                      Prix
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="mb-3">
                    <label htmlFor="newAdImageFile" className="form-label">
                      Ajouter une image
                    </label>
                    <input
                      type="file"
                  ...
                  <div className="mb-3">
                    <label htmlFor="newAdCategory" className="form-label">
                      Catégorie
                    </label>
                    <select
                ...
                {/* List of Ads */}
                <h4 className="mt-4 mb-3 text-secondary">
                  <i className="bi bi-card-list me-2"></i> Vos annonces
                  actuelles
                </h4>
                        ...
                        <div className="card h-100 shadow-sm">
                          ...
                          <div className="card-body d-flex flex-column">
                            ...
                            <p className="card-text mb-1">
                              <strong>Prix:</strong>{" "}
                              <span className="text-success">{ad.price}</span>
                            </p>
                            {ad.category && (
                              <p className="card-text mb-1">
            ...
            {activeSection === "categories" && (
              <div>
                <h3 className="mb-4 text-primary">
                  <i className="bi bi-tag me-2"></i> Gérer les catégories
                </h3>
                <p className="text-muted border-bottom pb-2 mb-3">
                  Ajoutez, supprimez et gérez les catégories disponibles pour
                  toutes les annonces.
                </p>
                ...
                {/* List of Categories */}
                <h4 className="mt-4 mb-3 text-secondary">
                  <i className="bi bi-list-nested me-2"></i> Toutes les
            ...
            {activeSection === "messages" && (
              <div>
                ...
                <p className="text-muted border-bottom pb-2 mb-3">
                  Consultez et répondez à tous vos messages et appels.
                </p>
                ...
                {currentUser.messages && currentUser.messages.length > 0 ? (
                  <div className="list-group mb-4">
                    {currentUser.messages.map((message) => (
                      <div
                        key={message.id}
                        className="list-group-item list-group-item-action shadow-sm mb-2 p-3"
                      >
                ...
                <div className="card p-3 border-primary-subtle bg-light">
                  <h5 className="mb-3 text-primary-emphasis">
                    <i className="bi bi-envelope-plus me-2"></i> Envoyer un
                    nouveau message
                  </h5>
                  <div className="mb-3">
                    <input
                      type="text"
                      className="form-control"
                      placeholder="Destinataire (Email ou Nom d'utilisateur)"
                    />
                  </div>
                  <div className="mb-3">
                    <input
            ...
            {activeSection === "payments" && (
              <div>
                <h3 className="mb-4 text-primary">
                  <i className="bi bi-credit-card me-2"></i> Historique des
                  Paiements
                </h3>
                <p className="text-muted border-bottom pb-2 mb-3">
                  Consultez toutes vos transactions financières passées.
                </p>
                ...
                {/* Payment Methods */}
                <h4 className="mt-4 mb-3 text-secondary">
                  <i className="bi bi-wallet2 me-2"></i> Méthodes de Paiement
                </h4>
                <p className="text-muted">
                  Ajoutez ou gérez vos informations de paiement. Notez que les
                  transactions réelles sont gérées par des plateformes
                  sécurisées.
                </p>
                <div className="card p-3 border-primary-subtle bg-light">
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      id="accountName"
                      placeholder="Nom sur la carte/compte"
                    />
                  </div>
                  <button className="btn btn-primary w-100">
                    <i className="bi bi-credit-card-fill me-2"></i> Ajouter
                    Méthode de Paiement
                  </button>
                </div>
              </div>
      ...
      <div className="d-flex justify-content-center gap-3 mt-5">
        ...
        <button
          onClick={() => navigate("/")}
          className="btn btn-info btn-lg px-4 shadow-sm"
        >
